//ссылка - https://webdesign-master.ru/blog/tools/gulp-4-lesson.html
...
function scripts() {
    return src([ // Берем файлы из источников
        ...
        'app/js/auth.js', // Пользовательские скрипты, использующие библиотеку, должны быть подключены в конце
        'app/js/cart.js',
        'app/js/menu.js',
        'app/js/partners.js'
    ])
...
function styles() {
    return src('app/sass/main.scss') // Выбираем источник: "app/sass/main.sass" или "app/less/main.less"
        ...
        .pipe(autoprefixer({ overrideBrowserslist: ['last 10 versions'], grid: true, cascade: true })) // Создадим префиксы с помощью Autoprefixer
...
function buildcopy() {
    return src([ // Выбираем нужные файлы
        'app/css/**/*.min.css',
        'app/js/**/*.min.js',
        'app/images/dest/**/*.{jpg,png,svg,gif,ico,webp}',
        'app/**/*.html',
